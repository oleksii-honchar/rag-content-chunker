...
export class WatchSource {
  ...
  get include(): string[] { return this.props.include; }
  get exclude(): string[] { return this.props.exclude; }
  get debounceMs(): number { return this.props.debounceMs; }
  get ignorePatterns(): string[] { return this.props.ignorePatterns; }
}
