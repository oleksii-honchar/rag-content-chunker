...
import { Chunker } from '../strategies/chunker.interface';
...
describe('ChunkContentUseCase', () => {
  ...
  beforeEach(() => {
    ...
    useCase = new ChunkContentUseCase(mockStrategyFactory as unknown as StrategyFactory, mockLogger as unknown as BasePinoLogger);
  });
